  ...
  <div class="inner">
    ...
    <section class="page write">
      ...
      <article class="group button">
        ...
        <button @click="postfetch_weakness" :disabled="!isAllInput">완료</button>
      </article>
...
const postData = ref({
  reportType: "weakness",
  data: {
    eventReportId: route.params.eventReportId,
    cyberAsset: "",
...
const openSaveDone = () => {
  store.setModalInfo({
    ...
    type: "onebtn",
    iconClass: "success",
    textArea: "Event Weakness Report 가 등록되었습니다.",
    btnText: "확인",
